...
<template>
    <section id="portfolio-section" class="border border-blue-500 flex flex-col items-center justify-center gap-4">
        <!-- 作品集標題 -->
        ...
        <!-- 作品集展示頁 -->
        <div class="min-h-[65vh] border border-green-500 w-full flex items-start gap-6">
            
            <!-- 左邊資訊區 (固定寬度，避免被右側預覽擠壓) -->
            <div class="w-80 min-w-65" >
