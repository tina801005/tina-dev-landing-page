...
<template>
    <section id="about-section" aria-labelledby="about-title" class="flex flex-col items-center justify-center gap-4 pb-30 ">
        <!-- 頁面標題 -->
  ...
  <path fill-rule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clip-rule="evenodd" />
                            ...
                            <div :id="`accordion-panel-${item.id}`" role="region" :aria-labelledby="`accordion-trigger-${item.id}`" class="border-t border-slate-400/30 mt-4 pt-4 flex flex-col items-start gap-2 text-slate-900 text-sm md:text-base transition-all duration-300"
            ...
            <!-- 右側 skills, 技能膠囊 -->
            <div class=" w-1/3  flex flex-col gap-4 p-2">
